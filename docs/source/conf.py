# -*- coding: utf-8 -*-
#
# mlpy documentation build configuration file, created by
...
project = u'mlpy'
copyright = u'2011, mlpy Developers'
...
latex_documents = [
  ('index', 'mlpy.tex', u'mlpy Documentation',
   u'Davide Albanese', 'manual'),
]
...
man_pages = [
    ('index', 'mlpy', u'mlpy Documentation',
     [u'mlpy Developers'], 1)
]
